...
class Tagging:
    ...
    def get_album_tags_from_dir(self):
        ...
        for track_file in audio_source_files:
            ...
            track_tag_dict = dict()
            track_tag_dict[literals.artist] = _titlecase(artist.title())
            track_tag_dict[literals.album] = _titlecase(album.title())
            track_tag_dict[literals.year] = year
            track_tag_dict[literals.title] = _titlecase(title.title())
            track_tag_dict[literals.genre] = _titlecase(genre.title())
            track_tag_dict[literals.comment] = 'Generated by all new lossless2lossy.py!'
